...
void GuiMapSelectorCtrl::drawRotatableBitmap(GFXTextureObject* texture, const RectF &dstRect, const RectF &srcRect, F32 angle, const GFXBitmapFlip in_flip = GFXBitmapFlip_None) {
